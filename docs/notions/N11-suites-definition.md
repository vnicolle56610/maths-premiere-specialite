...
- Comprendre qu'une suite est définie sur les entiers.
- Utiliser les notations \(u_n\) et \(u_{n+1}\).
- Passer d'une formule explicite à une relation de récurrence.
