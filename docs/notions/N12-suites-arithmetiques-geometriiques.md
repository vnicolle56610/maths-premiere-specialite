...
- Déterminer une raison et une formule explicite.
- Choisir un modèle adapté à une évolution discrète.
...
- [Corrigé TD N12](../corriges/CORRIGE_TD_N12_SUITES_ARITHMETIQUES_GEOMETRIQUES.pdf)
<!-- AUTO-DOCS:END -->
