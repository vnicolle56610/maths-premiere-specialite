...
- Utiliser une approximation affine locale.

## Documents

<!-- AUTO-DOCS:START -->
- [Cours N08 — Nombre dérivé derivation](../cours/COURS_N08_NOMBRE_DERIVE_DERIVATION.pdf)
- [TD N08 — Nombre dérivé derivation](../td/TD_N08_NOMBRE_DERIVE_DERIVATION.pdf)
- [Automatismes N08 — Nombre dérivé derivation](../automatismes/AUTOMATISMES_N08_NOMBRE_DERIVE_DERIVATION.pdf)
